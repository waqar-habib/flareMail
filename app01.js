...
database.ref().on("child_added", function (childSnapshot) {
  ...
  $("#generatedCode").append(
    ...
    '<tr><td colspan="2" id="fullName" style="font-weight: bold; color: rgb(5, 113, 255); font-size: 24px; font-family: Arial, Helvetica, sans-serif;">' + fullName + '</td></tr>' +
    // Concatenate job title
    '<tr><td colspan="2" id="jobTitle" style="color: #333333; font-size: 14px; font-family: Arial, Helvetica, sans-serif">' + jobTitle + '</td> </tr>' +
    // Concatenate phone
    '<tr><td colspan="2" id="cellPhone" style="vertical-align: top; color: #333333; font-size: 14px; font-family: Arial, Helvetica, sans-serif;">' + 'Phone: ' + phone + '</td></tr>' +
    // Concatenate company
    '<tr><td colspan="2" id="company"style="vertical-align: top; color: #333333; font-size: 14px; font-family: Arial Helvetica, sans-serif;">' + company + '</td></tr>' +
    // Concatenate website
    ' <tr><td valign="top" id="website"><a href="" style= "vertical-align: top; color: #333333; font-size: 14px; font-family: Arial, Helvetica, sans-serif;text-decoration: none">' + 'Website: ' + website + '</a></td></tr>' +
    // Concatenate email
    '<td colspan="2" id="email"><a href=""style="vertical-align: top; color: #333333; font-size: 14px; font-family: Arial, Helvetica, sans-serif;text-decoration: none">' + 'Email: ' + email + '</a></td></tr>' +
    // Concatenate address one & two, city, state, zip
    '<tr><td colspan="2" style="vertical-align: top; color: #333333; font-size: 14px; font-family: Arial, Helvetica, sans-serif;"><p><span></span>Address 1</span><span id="addressOne">' + addressOne + '</span><span id="addressTwo">' + addressTwo + '</span></p></td></tr>' +
