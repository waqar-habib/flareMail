...
database.ref().on("child_added", function (childSnapshot) {
  ...
  $("#generatedCode").append(
    ...
    // Concatenate email
    '<td colspan="2"><a href="" style="vertical-align: top; color: #333333; font-size: 14px; font-family: Arial, Helvetica, sans-serif;text-decoration: none">' + 'Email: ' + email + '</a></td></tr>' +
    // Closing tags
